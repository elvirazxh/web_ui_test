...
//    private String path = System.getProperty("user.dir")+File.separator+reportdate+"report.html";
    ...
    private String name = "UI WEB Selenium 测试报告";
    ...
    private void outputResult(List<ITestResult> list) {
        try {
            ...
            try {
                output = new BufferedWriter( new OutputStreamWriter(new FileOutputStream(new File(path)),"utf-8"));
